...
describe('Temperature', function () {
  it('Conversions should not be empty', function () {
    let celciuses = new Temp('celcius', ['kelvin', 'fahrenheit']);
  ...
  it('Conversions should not be empty', function () {
    let kelvin = new Temp('kelvin', ['celcius', 'fahrenheit']);
  ...
  it('Conversions should not be empty', function () {
    let fahrenheit = new Temp('fahrenheit', ['celcius', 'kelvin']);
  ...
  it('Conversions should not be empty', function () {
    let temp = new Temp('', ['celcius', 'kelvin', 'fahrenheit']);
