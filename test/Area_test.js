...
describe('Area', function () {
  ...
  it('Standard Conversion should not be empty for m2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_m2, 10),
      '',
      'm2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for m2', function () {
    assert.notStrictEqual(
      getAllConversions(100, 5, unit_object_m2, listOfUnits_m2),
      '',
      'm2 conversion should not be empty'
    );
  });
  ...
  it('Standard Conversion should not be empty for cm2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_cm2, 20),
      '',
      'cm2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for cm2 ', function () {
    assert.notStrictEqual(
      getAllConversions(200, 2, unit_object_cm2, listOfUnits_cm2),
      '',
      'cm2 conversion should not be empty'
    );
  ...
  it('Standard Conversion should not be empty for km2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_km2, 10),
      '',
      'km2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for km2 ', function () {
    assert.notStrictEqual(
      getAllConversions(100, 4, unit_object_km2, listOfUnits_km2),
      '',
      'km2 conversion should not be empty'
    );
    // assert.notStrictEqual(getAllConversions(0),"");
  ...
  it('Standard Conversion should not be empty for miles2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_miles2, 30),
      '',
      'miles2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for miles2 ', function () {
    assert.notStrictEqual(
      getAllConversions(100, 3, unit_object_miles2, listOfUnits_miles2),
      '',
      'miles2 conversion should not be empty'
    );
    // assert.notStrictEqual(getAllConversions(0),"");
  ...
  it('Standard Conversion should not be empty for ft2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_ft2, 10),
      '',
      'ft2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for ft2 ', function () {
    assert.notStrictEqual(
      getAllConversions(100, 7, unit_object_ft2, listOfUnits_ft2),
      '',
      'ft2 conversion should not be empty'
    );
    // assert.notStrictEqual(getAllConversions(0),"");
  ...
  it('Standard Conversion should not be empty for in2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_in2, 10),
      '',
      'in2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for in2 ', function () {
    assert.notStrictEqual(
      getAllConversions(100, 2, unit_object_in2, listOfUnits_in2),
      '',
      'in2 conversion should not be empty'
    );
    // assert.notStrictEqual(getAllConversions(0),"");
  ...
  it('Standard Conversion should not be empty for ha2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_ha2, 10),
      '',
      'ha2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for ha2', function () {
    assert.notStrictEqual(
      getAllConversions(100, 5, unit_object_ha2, listOfUnits_ha2),
      '',
      'ha2 conversion should not be empty'
    );
    // assert.notStrictEqual(getAllConversions(0),"");
  ...
  it('Standard Conversion should not be empty for acre2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_acre2, 10),
      '',
      'acre2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for acre2 ', function () {
    assert.notStrictEqual(
      getAllConversions(100, 10, unit_object_acre2, listOfUnits_acre2),
      '',
      'acre2 conversion should not be empty'
    );
    // assert.notStrictEqual(getAllConversions(0),"");
  ...
  it('Standard Conversion should not be empty for yd2', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_yd2, 10),
      '',
      'yd2 conversion should not be empty'
    );
  });
  it('All the conversions should not be empty for yd2', function () {
    assert.notStrictEqual(
      getAllConversions(100, 6, unit_object_yd2, listOfUnits_yd2),
      '',
      'yd2 conversion should not be empty'
    );
    // assert.notStrictEqual(getAllConversions(0),"");
