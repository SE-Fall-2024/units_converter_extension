...
describe('Data', function () {
  ...
  it('All Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(1, 5, unit_object_byte, object_list_byte),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(1.5, 8, unit_object_byte, object_list_byte),
      ''
    );
  });
  ...
  it('All Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(1, 5, unit_object_kb, object_list_kb),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(1.5, 8, unit_object_kb, object_list_kb),
      ''
    );
  });
  ...
  it('All Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(1, 5, unit_object_gb, object_list_gb),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(1.5, 8, unit_object_gb, object_list_gb),
      ''
    );
  });
  ...
  it('All Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(1, 5, unit_object_tb, object_list_tb),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(1.5, 8, unit_object_tb, object_list_tb),
      ''
    );
  });
});
