...
describe('Mass', function () {
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(49, 2, unit_object_kg, object_list_kg),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-49, 2, unit_object_kg, object_list_kg),
  ...
  it('All Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(490.5, 2, unit_object_kg, object_list_kg),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-490.5, 2, unit_object_kg, object_list_kg),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(49, 2, unit_object_grams, object_list_grams),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-49, 2, unit_object_grams, object_list_grams),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(490.5, 2, unit_object_grams, object_list_grams),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-490.5, 2, unit_object_grams, object_list_grams),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(49, 2, unit_object_pound, object_list_pound),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-49, 2, unit_object_pound, object_list_pound),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(490.5, 2, unit_object_pound, object_list_pound),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-490.5, 2, unit_object_pound, object_list_pound),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(49, 2, unit_object_tonne, object_list_tonne),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-49, 2, unit_object_tonne, object_list_tonne),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(490.5, 2, unit_object_tonne, object_list_tonne),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-490.5, 2, unit_object_tonne, object_list_tonne),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(49, 2, unit_object_mg, object_list_mg),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-49, 2, unit_object_mg, object_list_mg),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(490.5, 2, unit_object_mg, object_list_mg),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-490.5, 2, unit_object_mg, object_list_mg),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(49, 2, unit_object_microgram, object_list_microgram),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-49, 2, unit_object_microgram, object_list_microgram),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(490.5, 2, unit_object_microgram, object_list_microgram),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(
        -490.5,
        2,
        unit_object_microgram,
        object_list_microgram
      ),
      ''
    );
  });
  ...
  it('Standard Conversions should not be empty', function () {
    assert.notStrictEqual(
      getStandardConversion(unit_object_microgram, 100.5),
      ''
    );
  });
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(49, 2, unit_object_ounces, object_list_ounces),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-49, 2, unit_object_ounces, object_list_ounces),
  ...
  it('Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(490.5, 2, unit_object_ounces, object_list_ounces),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-490.5, 2, unit_object_ounces, object_list_ounces),
