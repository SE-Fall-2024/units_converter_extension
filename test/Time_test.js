...
describe('Time', function () {
  ...
  it('All Conversions should not be empty for seconds', function () {
    assert.notStrictEqual(
      getAllConversions(-1, 5, unit_object_second, object_list_second),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-1.5, 5, unit_object_second, object_list_second),
      ''
    );
  });
  ...
  it('All Conversions should not be empty for minutes', function () {
    assert.notStrictEqual(
      getAllConversions(10, 3, unit_object_mn, object_list_mn),
      ''
    );
    assert.notStrictEqual(
      getAllConversions(-1, 3, unit_object_mn, object_list_mn),
      ''
    );
  });
  ...
  it('Standard Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(10, 2, unit_object_hr, object_list_hr),
      ''
    );
  });
  ...
  it('Standard Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(15, 3, unit_object_dy, object_list_dy),
      ''
    );
  });
  ...
  it('Standard Conversions should not be empty', function () {
    assert.notStrictEqual(
      getAllConversions(25, 3, unit_object_wk, object_list_wk),
      ''
    );
  });
});
