...
describe('Energy', function () {
    describe('#getStandardConversion(quantity)', function () {
        ...
        it('should return approximately 12.552 when quantity is 3 gram calories', function () {
            assert.strictEqual(getStandardConversion(unit_object_calorie, 3).toFixed(3), (3 / 0.239006).toFixed(3));
        });
        ...
        it('should return approximately 12552.18 when quantity is 3 kilocalories', function () {
            assert.strictEqual(getStandardConversion(unit_object_kilocalorie, 3).toFixed(2), (3 / 0.000239006).toFixed(2));
        });
        ...
        it('should return approximately 10800 when quantity is 3 watt hours', function () {
            assert.strictEqual(getStandardConversion(unit_object_wh, 3).toFixed(0), (3 / 0.000277778).toFixed(0));
        });
        ...
        it('should return approximately 10800000 when quantity is 3 kilowatt hours', function () {
            assert.strictEqual(getStandardConversion(unit_object_kwh, 3).toFixed(0), (3 / 0.000000277778).toFixed(0));
        });
        ...
        it('should return approximately 1.8726e19 when quantity is 3 electronvolts', function () {
            assert.strictEqual(getStandardConversion(unit_object_ev, 3).toFixed(2), (3 / (1 / 6.242e18)).toFixed(2));
        });
        ...
        it('should return approximately 3168.73 when quantity is 3 BTUs', function () {
            assert.strictEqual(getStandardConversion(unit_object_btu, 3).toFixed(2), (3 / 0.000947817).toFixed(2));
        });
        ...
        it('should return a very large number when quantity is 3 therms', function () {
            assert.strictEqual(getStandardConversion(unit_object_therm, 3).toFixed(2), (3 / 9.4804e-6).toFixed(2));
        });
        ...
        it('should return approximately 4.07 when quantity is 3 foot-pounds', function () {
            assert.strictEqual(getStandardConversion(unit_object_ft_lb, 3).toFixed(2), (3 / 0.737562).toFixed(2));
        });
        ...
        it('should handle floating-point values accurately for electronvolts', function () {
            assert.strictEqual(getStandardConversion(unit_object_ev, 1.234e-9).toFixed(3), (1.234e-9 / (1 / 6.242e18)).toFixed(3));
        });
    });
});